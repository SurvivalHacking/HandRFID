...
//  Supports: ESP32-2432S024R/C (2.4") / ESP32-2432S028R (2.8") / ESP32-024 (2.4) Clone
//
...
//  DISPLAY SELECTION – must match config.h!
// ============================================================
#define DISPLAY_24C    // ESP32-024 – 2.4" CYD CLONE
//#define DISPLAY_24    // ESP32-2432S024R/C – 2.4" CYD GUITTON
//#define DISPLAY_28  // ESP32-2432S028R   – 2.8" CYD GUITTON

#ifdef DISPLAY_24
  #define USER_SETUP_INFO "ESP32-2432S024R/C CYD 2.4 inch"
  #define ILI9341_DRIVER	
#elif defined(DISPLAY_24C)
  #define USER_SETUP_INFO "ESP32-024 CYD CLONE 2.4 inch"
