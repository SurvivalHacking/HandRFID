...
static const char* strCalibInstr[LANG_COUNT] = { "Press each point for at least 1 second!", "Premi ogni punto per almeno 1 secondo!", "Appuyez sur chaque point 1 s min!" };
